    ...
    def _extract_gaps(self, sentence, tree):
        ...
        if len(entities) > 150:
            ...
            for entity in entities:
                ...
                x = candidate_gap.find(" \'")
                if x != -1:
                    candidate_gap = candidate_gap[:x] + candidate_gap[x+1:]

                candidate_gap = candidate_gap.replace("'","’")
                #candidate_gap = candidate_gap.replace('"','“')
                ...
                #print('Candidate: ', candidate, candidate_gap )
